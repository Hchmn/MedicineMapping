...
<html lang="en" dir="ltr">
  ...
  <body style="overflow:hidden;">
    ...
    <div class="d-flex flex-row h-100 w-100">
      ...
      <div class="col-2 flex-column d-flex h-75 w-75 mt-5 border"style="background: white !important; font-family:Times; margin-left: 90px;">
        <div class="medicine container h-100 w-100 mt-3 mb-3" style="border-radius: 30px 30px 30px 30px; overflow-y:scroll; margin-left:5px;" >
          <p class="m-0 mt-2 " style="color:black; font-size:160%; text-align:center; font-family:Helvetica; font-weight:bold;">
            <small >Top 10 Searched Medicine</small>
          </p>
          <p class="medicines mt-4 mb-3" style="color:black; font-size:140%; text-align:left; font-family:Times;">

            <small>1.  Medicine Name  </small>
            <br>
            <small>2.  Medicine Name  </small>
            <br>
            <small>3.  Medicine Name  </small>
            <br>
            <small>4.  Medicine Name  </small>
            <br>
            <small>5.  Medicine Name  </small>
            <br>
            <small>6.  Medicine Name  </small>
            <br>
            <small>7.  Medicine Name  </small>
            <br>
            <small>8.  Medicine Name  </small>
            <br>
            <small>9.  Medicine Name  </small>
            <br>
            <small>10.  Medicine Name  </small>
          </p>

          <p class="m-0 mt-4 " style="color:black; font-size:160%; text-align:center; font-family:Helvetica; font-weight:bold;">
            <small >Top 10 Sold Medicine (Weekly)</small>
          </p>
          ...
          <p class="m-0 mt-4 " style="color:black; font-size:160%; text-align:center; font-family:Helvetica; font-weight:bold;">
            <small >Top 10 Sold Medicine (Monthly)</small>
          </p>
        ...
        <div class="list_medicine container h-100 w-100  mt-2 mb-2" style="border-radius: 30px 30px 30px 30px;">
          <div class="topnav">
            <div class="searchbar mb-2 mt-2 border border-primary" style="float:Left; margin-left:7px;">
              <input class="search_input" id="myInput" onkeyup="myFunction()" type="" name="" placeholder="Search Medicine...." style="width:200px;">
              <a href="" class="search_icon"><i class="fa fa-search"></i></a>
            </div>
          </div>

        <table id ="myTable" class="table table-bordered mt-3" style="margin-left:7px;">
         <thead id =""class="" style="background:#54BEFF;">
           <tr>
             <th>ID No.</th>
             <th>Generic Name</th>
             <th>Brand Name</th>
         ...
         <tbody style="background-color:#fff;">
           <tr>
             ...
             <td><button class="btn btn-primary" data-toggle="modal" type="button" data-target="#update_modal"><span class="glyphicon glyphicon-edit"></span>Edit Price</button></td>
           </tr>
         </tbody>
         <tbody style="background-color:#fff;">
           <tr>
              ...
              <div class="modal-body">
                ...
                <div class="col-md-8">
                  <div class="form-group" >
                    <label style="font-style:Tahoma; font-size: 20px;">Price</label>
                    <input type="text " name="price" value="" class="form-control mt-1 mb-2 rounded" required="required"/>
                  </div>
                </div>
              </div>
              <div style="clear:both;"></div>
                <div class="modal-footer">
                  <button name="update" class="btn rounded border border-primary "><span class="glyphicon glyphicon-edit"></span> Update</button>
